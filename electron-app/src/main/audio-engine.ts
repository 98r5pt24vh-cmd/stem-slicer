...
export class AudioEngineService {
  private readonly appCachePath: string
  ...
  constructor(
    ...
    isPackaged = false,
    private readonly acceptedCachePath = path.join(path.dirname(appCachePath), "1.9"),
  ) {
  ...
  private ensureStarted(): Promise<void> {
    ...
    const environment = {
      ...
      STEM_SLICER_DIAGNOSTICS_DIR: path.join(this.appCachePath, "diagnostics"),
