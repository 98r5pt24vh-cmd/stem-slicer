...
export interface StemSlicerDesktopApi {
  ...
  getLibraryProducers: (primaryProducer?: string, libraryRoots?: string[], producerIdentities?: ProducerIdentity[]) => Promise<LibraryProducerSummary[]>
  ...
  cloudRemoveConnection: (connectionId: string) => Promise<CloudState>
