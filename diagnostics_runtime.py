...
def configure_runtime_environment(app_name: str = "Stem Slicer", version: str = "1.9") -> dict:
    ...
    try:
        ...
        applied = {
            ...
            "HF_HUB_CACHE": str(directories["huggingface_hub"]),
            "HUGGINGFACE_HUB_CACHE": str(directories["huggingface_hub"]),
            "TRANSFORMERS_CACHE": str(directories["transformers"]),
